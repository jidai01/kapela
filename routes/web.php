...
Route::get('/kelola/detail-pengumuman/{id}', [PengumumanController::class, 'detail'])->middleware(CekLogin::class);
...
Route::get('/kelola/detail-berita/{id}', [BeritaController::class, 'detail'])->middleware(CekLogin::class);
