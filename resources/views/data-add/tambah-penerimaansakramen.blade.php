        ...
        <div class="form-card">
            ...
            <form action="/kelola/kirim-penerimaan-sakramen" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select id="id_sakramen" class="form-select" name="id_sakramen" required>
                ...
                <div class="mb-3">
                    ...
                    <select id="nik" class="form-select" name="nik" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_penerimaan_sakramen"
                        name="tanggal_penerimaan_sakramen" required>
                </div>
