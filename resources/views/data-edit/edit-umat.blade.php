        ...
        <div class="form-card">
            ...
            <form action="/kelola/update-umat" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Alamat">{{ old('alamat', $umat->alamat ?? '') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="id_kub" class="form-select" name="id_kub" required>
                        ...
                        @foreach ($kublist as $kub)
                            <option value="{{ $kub->id_kub }}" @selected($kub->id_kub == old('id_kub', $umat->id_kub))>
                                {{ $kub->nama_kub }}
                            </option>
                        @endforeach
                    </select>
