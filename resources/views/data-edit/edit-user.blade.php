...
@section('content')
    <div class="container d-flex justify-content-center my-2" style="min-height: 100vh;">
        <div class="card shadow p-4" style="width: 100%; max-width: 600px;">
            <h4 class="bg-dark text-light text-center mb-4 p-2 rounded">Form Edit Data User</h4>
            ...
            <form action="/kelola/update-user" method="POST">
                ...
                <button type="submit" class="btn btn-dark w-100 mb-2">Simpan Perubahan</button>
