            ...
            <form action="/kelola/update-kegiatan-wilayah" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_kegiatan_wilayah" name="nama_kegiatan_wilayah"
                        value="{{ old('nama_kegiatan_wilayah', $kegiatanwilayah->nama_kegiatan_wilayah) }}"
                    ...
                    <select id="id_wilayah" class="form-select" name="id_wilayah" required>
                        ...
                        @foreach ($wilayahlist as $wilayah)
                            <option value="{{ $wilayah->id_wilayah }}"
                                {{ old('id_wilayah', $kegiatanwilayah->id_wilayah) == $wilayah->id_wilayah ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="deskripsi">{{ old('deskripsi', $kegiatanwilayah->deskripsi) }}</textarea>
                </div>
